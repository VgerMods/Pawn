...
function PawnInitialize()
	...
	if not CurrentLocaleIsSupported then
		...
		if VgerCore.IsClassic then
			WrongLocaleMessage = "Sorry, this version of Pawn on WoW Classic is for English, French, German, Spanish, and Simplified Chinese only.  I'm working to support all languages soon."
		end
