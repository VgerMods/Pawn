...
PawnLocal.TooltipParsing = {
	...
	["HaventCollectedAppearance"] = "^你還沒收集到這個外觀$",
	["Healing"] = "^%+# 治療法術$",
...
if VgerCore.IsBurningCrusade or VgerCore.IsWrath or VgerCore.IsCataclysm or VgerCore.IsMists then
	...
	local TooltipParsing_BurningCrusade =
	{
		...
		["ArcaneSpellDamage2"] = "^裝備: 使祕法法術和效果所造成的傷害提高最多#點。$",
		["FireSpellDamage2"]   = "^裝備: 使火焰法術和效果所造成的傷害提高最多#點。$",
		["FrostSpellDamage2"]  = "^裝備: 使冰霜法術和效果所造成的傷害提高最多#點。$",
		["NatureSpellDamage2"] = "^裝備: 使自然法術和效果所造成的傷害提高最多#點。$",
		["ShadowSpellDamage2"] = "^裝備: 使暗影法術和效果所造成的傷害提高最多#點。$",
	}
