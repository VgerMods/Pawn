...
Pour plus d'information sur la Personnalisation de Pawn, regarder le fichier d'aide (Readme.htm) inclu dans le mod.]=],
	...
	["Stats"] = {
		...
		["IndestructibleIs"] = "Être |cffffffffffindestructible|r vaut la peine :",
		["IntellectInfo"] = "L'intelligence. Augmente la puissance de certaines classes.",
		["Leather"] = "Cuir",
		...
		["SpeedIs"] = "1 seconde |cffffffffffde vitesse de rotation|r vaut :",
		...
		["StaminaInfo"] = "L'endurance. Augmente votre santé.",
		["StrengthInfo"] = "La force. Augmente la puissance des capacités de certaines classes.",
		["VersatilityInfo"] = "La polyvalence. Augmente les dégâts infligés, les soins prodigués et réduit les dégâts infligés pour les spécialisations de tank.",
	...
	["UI"] = {
		...
		["AboutTranslation"] = "Francaise par Othor, Vernel, et CerealCH",
...
Chaque objet dans World of Warcraft a un numéro d'ID qui lui est associé. Cette information est généralement seulement utile aux auteurs de mods]=],
		...
		["OptionsQuestUpgradeAdvisorTooltip"] = "Dans votre journal de quêtes et lorsque vous parlez aux PNJs, si l'un des choix de récompense de quête est une amélioration de votre équipement actuel, Pawn affichera une icône de flèche verte sur l'objet. Si aucun des objets n'est une amélioration, Pion affichera une pile de pièces d'or sur l'objet qui rapporte le plus lors de la vente e l'objet.",
...
Cette commande ne peut etre défaite!]=],
		...
		["ValuesWelcomeReadOnly"] = "Cette échelle intégrée ne peut pas être modifiée. Si vous souhaitez personnaliser ces pondérations, allez dans l'onglet balance, activez le mode manuel et faites une copie de l'échelle actuelle.",
	}
}
