...
Shortcut: Shift+click auf ein Bewertungsprofil]=],
		...
		["ValuesFollowSpecialization"] = "Zeige nur Upgrades für meinen besten Rüstungstyp ab Level %d",
		["ValuesFollowSpecializationTooltip"] = "Aktiviere diese Option um Rüstungsupgrades zu verstecken für die deine Klasse nicht spezialisiert ist (ab Level %d).  Zum Beispiel lernt ein Heilig-Paladin ab Level %d Plattenspezialisierung, die seine Intelligenz um 5%% erhöht wenn er nur Plattenrüstung trägt.  Wenn diese Option ausgewählt ist wird Pawn keine Stoff, Leder oder Kettenrüstung als Upgrades für Level %d+ Heilig-Paladine berücksichtigen.",
