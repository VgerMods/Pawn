...
function PawnClassicScaleProvider_AddScales()
	...
	elseif VgerCore.IsMists then ------------------------------------------------------------
		...
		PawnAddPluginScaleFromTemplate(
			...
			10, -- Monk
			1, -- Brewmaster
			{ Intellect=0, Spirit=0, SpellPower=0, Agility=100, HitRating=65, ExpertiseRating=65, HasteRating=62, CritRating=54, ParryRating=50, Armor=46, DodgeRating=42, Ap=35, MasteryRating=31, Stamina=27, ResilienceRating=0, MetaSocketEffect=16000 }
		)
		...
		PawnAddPluginScaleFromTemplate(
			...
			10, -- Monk
			2, -- Mistweaver
			{ Agility=0, Armor=0, HitRating=0, DodgeRating=0, ParryRating=0, ExpertiseRating=0, Ap=0, Intellect=100, SpellPower=85, Spirit=75, HasteRating=60, CritRating=50, MasteryRating=40, Stamina=.1, ResilienceRating=0, MetaSocketEffect=16000 }
		)
		...
		PawnAddPluginScaleFromTemplate(
			...
			10, -- Monk
			3, -- Windwalker
			{ Intellect=0, Spirit=0, SpellPower=0, DodgeRating=0, ParryRating=0, HitRating=100, Agility=86, ExpertiseRating=79, HasteRating=46, CritRating=37, Strength=33, Ap=31, MasteryRating=21, Stamina=.1, ResilienceRating=0, MetaSocketEffect=16000 }
		)
